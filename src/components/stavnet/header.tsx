...
export function StavnetHeader({
  ...
  return (
    ...
    >
      <div
        className={cn(
          "hidden md:absolute md:bottom-[8px] md:left-[clamp(58px,5.2vw,112px)] md:block md:w-[270px]",
          logoClassName,
        )}
      >
        <Image
      ...
      <section
        className={cn(
          "hidden md:absolute md:bottom-[8px] md:left-[clamp(58px,5.2vw,112px)] md:right-[clamp(58px,5.2vw,112px)] md:flex md:min-h-[84px] md:flex-col md:items-end md:justify-end md:text-right md:[direction:ltr]",
          titleBlockClassName,
        )}
      >
        <h1
      ...
      {rightControl ? (
        <div
          className={cn(
            "hidden md:absolute md:left-[clamp(58px,5.2vw,112px)] md:right-[clamp(58px,5.2vw,112px)] md:top-[124px] md:flex md:justify-end md:text-right",
            rightControlClassName,
          )}
        >
          {rightControl}
