...
function analysisLabels(locale: string) {
  ...
  const labels = french ? {
    filterBar: "Filtres d’analyse", period: "Période", allPeriod: "Toute la période", lastTenYears: "10 dernières années", lastTwentyFiveYears: "25 dernières années", currentDecade: "Décennie en cours", customPeriod: "Période personnalisée", fromYear: "De l’année", toYear: "À l’année", allLanguages: "Toutes les langues", allCountries: "Tous les pays", allPublishers: "Tous les éditeurs", publisher: "Éditeur", scope: "Périmètre analysé : {period} · {language} · {country} · {publisher}.", periodRange: "de {from} à {to}", pocketScope: "Périmètre analysé : données biographiques disponibles.", birthCountriesScope: "Périmètre analysé : auteurs dont le pays de naissance est identifié.", filtersUnavailable: "Aucun filtre bibliographique fiable n’est disponible pour cette analyse.", timelineTitle: "Évolution par décennie du nombre d’ouvrages originaux et de traductions publiés.", originalAuthorsTitle: "Auteurs classés selon le nombre d’ouvrages originaux publiés.", originalBooksTitle: "Ouvrages originaux classés selon leur nombre de publications.", translatedBooksTitle: "Ouvrages classés selon leur nombre de traductions publiées.", translatedAuthorsTitle: "Auteurs classés selon le nombre de leurs ouvrages publiés en traduction.", originalPublishersTitle: "Éditeurs classés selon le nombre d’ouvrages originaux publiés.", translatorsTitle: "Traducteurs classés selon le nombre de traductions publiées.", translationPublishersTitle: "Éditeurs classés selon le nombre de traductions publiées.", pocketReissuesTitle: "Auteurs classés selon leur nombre de rééditions au format poche.", languagesTitle: "Ouvrages publiés classés par langue de publication.", countriesTitle: "Répartition des ouvrages publiés par pays de publication.", genresTitle: "Répartition des ouvrages publiés par genre d’écriture.", birthCountriesTitle: "Répartition des auteurs par pays de naissance.", writingGenres: "Genres d’écriture", works: "Ouvrages", authors: "Auteurs", otherGenres: "Autres genres",
  } : {
    filterBar: "Analysis filters", period: "Period", allPeriod: "Entire period", lastTenYears: "Last 10 years", lastTwentyFiveYears: "Last 25 years", currentDecade: "Current decade", customPeriod: "Custom period", fromYear: "From year", toYear: "To year", allLanguages: "All languages", allCountries: "All countries", allPublishers: "All publishers", publisher: "Publisher", scope: "Analysis scope: {period} · {language} · {country} · {publisher}.", periodRange: "from {from} to {to}", pocketScope: "Analysis scope: available biographical data.", birthCountriesScope: "Analysis scope: authors whose country of birth is identified.", filtersUnavailable: "No reliable bibliographic filter is available for this analysis.", timelineTitle: "Change by decade in the number of original works and translations published.", originalAuthorsTitle: "Authors ranked by the number of original works published.", originalBooksTitle: "Original works ranked by their number of published editions.", translatedBooksTitle: "Works ranked by the number of published translations.", translatedAuthorsTitle: "Authors ranked by the number of their works published in translation.", originalPublishersTitle: "Publishers ranked by the number of original works published.", translatorsTitle: "Translators ranked by the number of published translations.", translationPublishersTitle: "Publishers ranked by the number of published translations.", pocketReissuesTitle: "Authors ranked by their number of pocket-format reissues.", languagesTitle: "Published works ranked by publication language.", countriesTitle: "Breakdown of works published by country of publication.", genresTitle: "Breakdown of published works by writing genre.", birthCountriesTitle: "Breakdown of authors by country of birth.", writingGenres: "Writing genres", works: "Works", authors: "Authors", otherGenres: "Other genres",
  };
  const focusedTimelineLabels = {
    fr: {
      countryPublicationsTitle: "Évolution par décennie du nombre de livres publiés dans le pays sélectionné.",
      translationLanguageTitle: "Évolution par décennie du nombre de traductions publiées dans la langue sélectionnée.",
      countryPublicationsScope: "Pays de publication analysé : {country}. Toutes les périodes sont incluses.",
      translationLanguageScope: "Langue de traduction analysée : {language}. Toutes les périodes sont incluses.",
    },
    en: {
      countryPublicationsTitle: "Change by decade in the number of books published in the selected country.",
      translationLanguageTitle: "Change by decade in the number of translations published in the selected language.",
      countryPublicationsScope: "Publication country analysed: {country}. All periods are included.",
      translationLanguageScope: "Translation language analysed: {language}. All periods are included.",
    },
    he: {
      countryPublicationsTitle: "התפתחות לפי עשור במספר הספרים שפורסמו במדינת הפרסום שנבחרה.",
      translationLanguageTitle: "התפתחות לפי עשור במספר התרגומים שפורסמו בשפה שנבחרה.",
      countryPublicationsScope: "מדינת הפרסום שנותחה: {country}. כל התקופות נכללות.",
      translationLanguageScope: "שפת התרגום שנותחה: {language}. כל התקופות נכללות.",
    },
    ar: {
      countryPublicationsTitle: "تطور عدد الكتب المنشورة في بلد النشر المحدد حسب العقد.",
      translationLanguageTitle: "تطور عدد الترجمات المنشورة باللغة المحددة حسب العقد.",
      countryPublicationsScope: "بلد النشر الذي جرى تحليله: {country}. تشمل البيانات جميع الفترات.",
      translationLanguageScope: "لغة الترجمة التي جرى تحليلها: {language}. تشمل البيانات جميع الفترات.",
    },
    de: {
      countryPublicationsTitle: "Entwicklung der Anzahl veröffentlichter Bücher im ausgewählten Publikationsland nach Jahrzehnt.",
      translationLanguageTitle: "Entwicklung der Anzahl veröffentlichter Übersetzungen in der ausgewählten Sprache nach Jahrzehnt.",
      countryPublicationsScope: "Analysiertes Publikationsland: {country}. Alle Zeiträume sind einbezogen.",
      translationLanguageScope: "Analysierte Übersetzungssprache: {language}. Alle Zeiträume sind einbezogen.",
    },
    es: {
      countryPublicationsTitle: "Evolución por década del número de libros publicados en el país seleccionado.",
      translationLanguageTitle: "Evolución por década del número de traducciones publicadas en el idioma seleccionado.",
      countryPublicationsScope: "País de publicación analizado: {country}. Se incluyen todos los periodos.",
      translationLanguageScope: "Idioma de traducción analizado: {language}. Se incluyen todos los periodos.",
    },
  };
  return { ...labels, ...(focusedTimelineLabels[locale as keyof typeof focusedTimelineLabels] ?? focusedTimelineLabels.en) };
}
...
export default async function StatisticsPage({ params, searchParams }: StatisticsPageProps) {
  ...
  const [t, books, persons, organizations, statistics, countryPublications, languageTranslations] = await Promise.all([
    getTranslations("StatisticsPage"),
    getBooksPage(1, COMPARISON_CANDIDATES_PAGE_SIZE).catch(() => ({ items: [], page: 1, total: 0, totalPages: 1 })),
    getPersonsPage(1, COMPARISON_CANDIDATES_PAGE_SIZE).catch(() => ({ items: [], page: 1, total: 0, totalPages: 1 })),
    getOrganizationsPage(1, COMPARISON_CANDIDATES_PAGE_SIZE).catch(() => ({ items: [], page: 1, total: 0, totalPages: 1 })),
    getGeneralStatistics(filters).catch(() => emptyGeneralStatistics),
    getGeneralStatistics(filters.country ? { country: filters.country } : {}).catch(() => emptyGeneralStatistics),
    getGeneralStatistics(filters.language ? { language: filters.language } : {}).catch(() => emptyGeneralStatistics),
  ]);
  const candidates = {
  ...
  const candidatePages = {
    books: { page: books.page, total: books.total, totalPages: books.totalPages },
    persons: { page: persons.page, total: persons.total, totalPages: persons.totalPages },
    organizations: { page: organizations.page, total: organizations.total, totalPages: organizations.totalPages },
  };
