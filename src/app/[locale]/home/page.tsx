...
export default function HomeMenuPage() {
  ...
  return (
    <main className="relative min-h-[100svh] w-full overflow-x-hidden bg-[#e7f2f7] font-[Arial,Helvetica,sans-serif] text-black md:h-screen md:overflow-hidden">
      ...
      <div className="relative z-20 mx-auto flex min-h-[100svh] w-full max-w-[620px] flex-col px-5 py-8 md:block md:h-screen md:max-w-none md:p-0">
        <StavnetHeader
          pageName="Welcome"
          badgeBody={
            <>
          ...
          titleBlockClassName="md:right-[4.9vw] md:left-auto md:top-[2.4vh] md:flex md:h-[110px] md:w-[39vw] md:flex-col md:items-end md:justify-center md:text-right"
          titleClassName="font-['Comic_Sans_MS','Trebuchet_MS',cursive] text-[36px] tracking-[1px] text-[#27236b] md:text-[38px]"
