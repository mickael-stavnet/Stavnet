  ...
  return (
    <main className="relative min-h-[100svh] overflow-x-hidden bg-[#e7f2f7] font-[Arial,Helvetica,sans-serif] text-black md:h-screen md:overflow-hidden">
      ...
      <div className="relative z-10 mx-auto flex min-h-[100svh] w-full max-w-[1120px] flex-col px-4 pb-5 pt-0 md:h-screen md:max-w-none md:px-0 md:pb-0 md:pt-0">
        ...
        <section className="mt-6 rounded-[16px] border border-[#9fc6d5] bg-[rgba(232,246,251,0.82)] p-4 shadow-[0_10px_24px_rgba(80,126,145,0.18)] backdrop-blur-[1px] md:absolute md:left-1/2 md:top-[286px] md:mx-auto md:max-h-[calc(100vh-400px)] md:w-[min(1104px,90.2vw)] md:-translate-x-1/2 md:overflow-y-auto md:p-5 [@media(max-height:950px)]:top-[214px] [@media(max-height:950px)]:max-h-[calc(100vh-334px)]">
